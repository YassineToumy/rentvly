  ...
  <div class="min-h-screen bg-white dark:bg-gray-950 flex">
    ...
    <div class="flex-1 flex items-center justify-center px-4 sm:px-8">
      <div class="w-full max-w-md">
        ...
        <!-- Heading -->
        <div class="mb-8">
          <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Content de vous revoir</h1>
    ...
    <!-- Right: Visual panel -->
    <div class="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-gray-900 via-gray-950 to-gray-900 border-l border-gray-200 dark:border-gray-800/60 relative overflow-hidden">
      ...
      <div class="relative z-10 max-w-sm text-center px-8">
        ...
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Estimez & Investissez</h2>
        ...
        <div class="mt-10 grid grid-cols-2 gap-3">
          <div class="p-3 rounded-lg bg-gray-100 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700/50 text-left">
            <p class="text-xs text-gray-600 dark:text-gray-500">Précision</p>
            <p class="text-lg font-bold text-primary-400">87%</p>
          </div>
          <div class="p-3 rounded-lg bg-gray-100 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700/50 text-left">
            <p class="text-xs text-gray-600 dark:text-gray-500">Annonces</p>
            <p class="text-lg font-bold text-gray-900 dark:text-white">50k+</p>
          </div>
        </div>
      </div>
    </div>
